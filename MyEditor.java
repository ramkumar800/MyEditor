...
str="";
 ...
 Process error =r.exec("c:\\Program Files\\java\\jdk-19\\bin\\javac.exe -d.  "+fname);
 ...
 Process p=r.exec("C:\\Program Files\\Java\\jdk-19\\bin\\java -cp .  "+fn);
 ...
 public void focusGainer(FocusEvent fe)
 {
